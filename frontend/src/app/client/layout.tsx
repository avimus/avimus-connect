  ...
  return (
    <>
      <div className="p-5 border-b" style={{ borderColor: 'var(--border-sidebar)' }}>
        <h1 className="font-bold text-sm" style={{ color: 'var(--accent)' }}>Ávimus Connect</h1>
      </div>
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div className="flex">
        ...
        <aside
          className={`fixed md:static inset-y-0 left-0 z-50 w-52 flex flex-col border-r transition-transform duration-300 md:translate-x-0 md:min-h-screen ${drawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
